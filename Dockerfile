...
RUN rm -rf /usr/local/tomcat/webapps/* COPY --from-builder /home/app/target/*.jar /usr/local/tomcat/webapps/ROOT.jar
ENV CATALINA_OPTS -javaagent:/home/app/jmx_prometheus_javaagent-0.16.1.jar-9000:/home/app/tomcat.yml
